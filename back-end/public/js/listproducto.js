async function eliminar(id) {
    try {
        swal({
            ...
            text: "¿Seguro que quieres eliminar el producto con id: " + id+ " ?",
            icon: "info"
        })
            .then( async (value) => {
                switch (value) {
                    case "ok":
                        let resultado = await fetch("http://localhost:3000/producto/delete/" + id, { // /nuevousuarios
                            method: 'get',
                            headers: {
